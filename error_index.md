...
description: >-
  ...
  trying to compile Terbium code.
---
...
Non-type identifier names should be snake\_case.
...
Instead, try using snake\_case instead:
...
When declaring a type, such as a class, try not to use snake\_case or any other casing:
